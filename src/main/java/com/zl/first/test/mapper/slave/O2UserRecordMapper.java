...
import static com.zl.first.test.mapper.slave.O2UserRecordDynamicSqlSupport.*;
import static org.mybatis.dynamic.sql.SqlBuilder.*;

import com.zl.first.test.model.slave.O2UserRecord;
...
@Mapper
public interface O2UserRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    ...
    int insert(InsertStatementProvider<O2UserRecord> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("O2UserRecordResult")
    O2UserRecord selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("O2UserRecordResult")
    List<O2UserRecord> selectManyWithRowbounds(SelectStatementProvider selectStatement, RowBounds rowBounds);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    default Function<SelectStatementProvider, List<O2UserRecord>> selectManyWithRowbounds(RowBounds rowBounds) {
        return selectStatement -> selectManyWithRowbounds(selectStatement, rowBounds);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="O2UserRecordResult", value = {
    ...
    List<O2UserRecord> selectMany(SelectStatementProvider selectStatement);
    ...
    default DeleteDSL<MyBatis3DeleteModelAdapter<Integer>> deleteByExample() {
        return DeleteDSL.deleteFromWithMapper(this::delete, o2UserRecord);
    }
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    default int insert(O2UserRecord record) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    default int insertSelective(O2UserRecord record) {
        return insert(SqlBuilder.insert(record)
                .into(o2UserRecord)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<O2UserRecord>>> selectDistinctByExample(RowBounds rowBounds) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<O2UserRecord>>> selectDistinctByExample() {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    default O2UserRecord selectByPrimaryKey(String id_) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(O2UserRecord record) {
        return UpdateDSL.updateWithMapper(this::update, o2UserRecord)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(O2UserRecord record) {
        return UpdateDSL.updateWithMapper(this::update, o2UserRecord)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    default int updateByPrimaryKey(O2UserRecord record) {
        return UpdateDSL.updateWithMapper(this::update, o2UserRecord)
                .set(userName).equalTo(record::getUserName)
                .set(dingId).equalTo(record::getDingId)
                .set(nickName).equalTo(record::getNickName)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: o2_user_record")
    default int updateByPrimaryKeySelective(O2UserRecord record) {
        return UpdateDSL.updateWithMapper(this::update, o2UserRecord)
                .set(userName).equalToWhenPresent(record::getUserName)
                .set(dingId).equalToWhenPresent(record::getDingId)
                .set(nickName).equalToWhenPresent(record::getNickName)
